...
public class LevelFeeling{
    ...
    public static final LevelFeeling DEFAULT_FEELING = new LevelFeeling("Default", null, null, null, new Distribution(new int[]{2,3,4,5,6}, new int[]{1,3,5,3,2}), 
            0.1, 0.05, 0.5, 0.5, 0.5, 0.5, 0.04, 0.03, 0.01, NoiseType.MIDPOINT, NoiseType.PERLIN, true, false, false,
    ...
    public static final LevelFeeling CAVE_FEELING = new LevelFeeling("Cave", null, null, null, new Distribution(new int[]{2,3,4,5,6}, new int[]{1,3,5,3,2}), 
            0.1, 0.05, 0.5, 0.5, 0.5, 0.5, 0.04, 0.03, 0.01, NoiseType.MIDPOINT, NoiseType.MIDPOINT, true, true, true,
